...
## Modified on 30th April 2023
## THIS CODE IS ORIGINALLY FROM THE REPO https://github.com/gmsoft-tuxicoman/bt-audio
## IT IS LICENSED GPL-V3
## I HAVE MODIFIED IT FOR THIS REPO IN ORDER TO AUTOMATICALLY EXIT WHEN THE DEVICE DISCONNECTS
## I ADDED `import os` , then - when the device disconnects - I run `os._exit(0)`
